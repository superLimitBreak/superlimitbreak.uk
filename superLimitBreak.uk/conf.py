...
BLOG_AUTHOR = "superLimitBreak"  # (translatable)
BLOG_TITLE = "superLimitBreak"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://superlimitbreak.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://superlimitbreak.uk/"
BLOG_EMAIL = "band@superLimitBreak.uk"
BLOG_DESCRIPTION = "A band that covers Anime and Game music with interesting tech"  # (translatable)
